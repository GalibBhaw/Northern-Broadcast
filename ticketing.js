...
(function () {
  ...
  function shell() {
    ...
    P('gmt').innerHTML = `
      ...
      <p>
        ...
        and receive your e-ticket once
  ...
  /* =========================================================
     ...
     IMPORTANT FIX:
     Button now sends event ID, not event code.
     ========================================================= */
  ...
  async function openGMT(code) {
    ...
    */
    ...
    renderList(
      ev
        ? note(
            `${esc(ev.name)}: tickets are not available.`,
            'err'
          )
        : ''
    );
  ...
  async function submit() {
    ...
    /*
      Payment orders stay pending.
      Admin must approve the payment.
    */

    body().innerHTML =

      note(
        '<b>Payment Verification Pending</b><br>' +
  ...
  function renderResult(
    ...
    if (
      ...
      el.innerHTML =
        note(
          '<b>Payment Rejected</b><br>' +
          'We could not verify your payment. ' +
          'Please contact us on WhatsApp: 01511588581.',
          'err'
        ) +
        head;
  ...
  async function verifyPage(
    ...
    el.innerHTML =
      ...
      '<p class="dim">Verifying ticket…</p>';
    ...
    P('admin').innerHTML = `
      ...
      <div class="subsection">
        ...
        <p
          ...
          style="font-size:.85rem"
        >
          To scan a QR code, use your phone camera.
          It opens the verification page, where you
          can mark the ticket as used while logged in.
        </p>
      ...
      <div class="subsection">
        ...
        <p class="dim">
          Set a date and price, then turn sales on
          to open ticket sales for an event.
        </p>
